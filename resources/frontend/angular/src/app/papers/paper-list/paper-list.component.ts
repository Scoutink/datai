...
import { PaperShareableLinkComponent } from '../paper-details/paper-shareable-link/paper-shareable-link.component';
...
export class PaperListComponent extends BaseComponent implements OnInit, AfterViewInit {
    ...
    onShareLink(paper: any) {
        this.paperService.getShareLink(paper.id).subscribe((link: any) => {
    ...
    onPermission(paper: any) {
        this.router.navigate(['/papers', paper.id], { queryParams: { tab: 'permission' } });
    }

    onVersionHistory(paper: any) {
        this.router.navigate(['/papers', paper.id], { queryParams: { tab: 'version' } });
    }

    onAuditTrail(paper: any) {
        this.router.navigate(['/papers', paper.id], { queryParams: { tab: 'audit' } });
    }
}
