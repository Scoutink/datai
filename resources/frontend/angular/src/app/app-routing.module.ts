      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            canLoad: [AuthGuard],
            loadChildren: () =>
              import('./papers/paper.module').then(
                (m) => m.PaperModule
              ),
          },
          {
          ...
          },
          {
            ...
            canActivate: [AuthGuard],
            loadComponent: () =>
              import('./boards/boards-list.component').then(
          ...
          },
          {
            ...
            canActivate: [AuthGuard],
            loadComponent: () =>
              import('./boards/board-detail.component').then(
          ...
          },
          {
            ...
            // canLoad: [AuthGuard], // Uncomment when claims are ready
          },
