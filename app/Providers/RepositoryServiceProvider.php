...
use App\Repositories\Implementation\BoardRepository;
use App\Repositories\Contracts\BoardMilestoneRepositoryInterface;
use App\Repositories\Implementation\BoardMilestoneRepository;
use App\Repositories\Contracts\PaperRepositoryInterface;
use App\Repositories\Implementation\PaperRepository;
use App\Repositories\Contracts\PaperPermissionRepositoryInterface;
use App\Repositories\Implementation\PaperPermissionRepository;
use App\Repositories\Contracts\PaperCommentRepositoryInterface;
use App\Repositories\Implementation\PaperCommentRepository;
use App\Repositories\Contracts\PaperVersionsRepositoryInterface;
use App\Repositories\Implementation\PaperVersionsRepository;
use App\Repositories\Contracts\PaperAuditTrailRepositoryInterface;
use App\Repositories\Implementation\PaperAuditTrailRepository;
use App\Repositories\Contracts\PaperShareableLinkRepositoryInterface;
use App\Repositories\Implementation\PaperShareableLinkRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(BoardMilestoneRepositoryInterface::class, BoardMilestoneRepository::class);
        $this->app->bind(PaperRepositoryInterface::class, PaperRepository::class);
        $this->app->bind(PaperPermissionRepositoryInterface::class, PaperPermissionRepository::class);
        $this->app->bind(PaperCommentRepositoryInterface::class, PaperCommentRepository::class);
        $this->app->bind(PaperVersionsRepositoryInterface::class, PaperVersionsRepository::class);
        $this->app->bind(PaperAuditTrailRepositoryInterface::class, PaperAuditTrailRepository::class);
        $this->app->bind(PaperShareableLinkRepositoryInterface::class, PaperShareableLinkRepository::class);
    }
