...
class PermissionSeederV56 extends Seeder
{
    public function run(): void
    {
        ...
        // cleanup legacy one-off permission code from old incomplete implementation
        Actions::where('pageId', $pageId)->where('code', 'ALL_PAPERS_VIEW')->delete();
    }
}
